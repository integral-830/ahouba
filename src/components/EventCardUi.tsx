...
const EventCardUi = (props: EventCardUiProps) => {
    ...
    return (
        <div className="w-full h-fit flex flex-col xl:flex-row gap-8 p-8 bg-gradient-to-b xl:bg-gradient-to-r from-teal-600 from-5% via-transparent to-teal-700 to-90% rounded-3xl">
