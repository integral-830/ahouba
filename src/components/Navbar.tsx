    ...
    return (
        <div ref={navRef}
            ...
            <div className="w-full flex items-center justify-between">
                <img onClick={()=>{ navigate("/")} } className="h-[60px] w-[60px] hover:scale-125 transition-all ease-in duration-300" src="https://pub-c94b02dd33c14b448990be89eff7f07f.r2.dev/ahoubaLogo.svg"
                     alt="icon"/>
