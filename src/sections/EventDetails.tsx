...
const EventDetails = () => {
    return (
        <section className=" relative min-h-lvh w-screen overflow-hidden bg-[#a8a8d7] p-20">
            ...
            <div className="w-full h-full flex flex-col lg:flex-row gap-8 p-8 items-center rounded-3xl">
                ...
                <div className="w-full lg:w-2/3 h-fit md:p-10 rounded-2xl flex flex-col gap-4 overflow-hidden">
                    <h1 className=" text-[5dvh] font-coaster">PUBG</h1>
                    <p className=" text-[2dvh] md:text-[2.5dvh] h-fit font-Roobert overflow-hidden">The Cyber Cleuth
                        Competition
                    ...
                    <div className=" flex w-full h-fit gap-6 justify-items-start overflow-hidden">
                        <div className="w-fit h-fit rounded-full flex gap-2 items-center px-4 py-2 bg-[#9898ce] overflow-hidden">
                            <LuCalendarFold size="15"/>
                            <h2 className=" text-[1.3dvh] md:text-[2dvh] font-Roobert text-center">12/11/25</h2>
                        </div><div className="w-fit h-fit rounded-full flex gap-2 items-center px-4 py-2 bg-[#9898ce] overflow-hidden">
                        <GoClock size="15"/>
                    ...
                    <div className="grid grid-cols-7 grid-rows-4 gap-4">
                        <div className="col-span-2"><h1 className="text-[2dvh] md:text-[3dvh] font-coaster">Cash
                            Prize</h1></div>
                        <div className="col-span-2 col-start-1 row-start-2"><h1 className="text-[2dvh] md:text-[3dvh] font-coaster">Entry Fee</h1></div>
                        <div className="col-span-2 col-start-1 row-start-3"><h1 className="text-[2dvh] md:text-[3dvh] font-coaster">Organised By</h1></div>
                        <div className="col-span-2 col-start-1 row-start-4"><h1 className="text-[2dvh] md:text-[3dvh] font-coaster">Contact</h1></div>
                        <div className="col-start-3 row-start-1"><h1 className=" text-[3dvh] font-coaster">:</h1></div>
                        <div className="col-start-3 row-start-2"><h1 className=" text-[3dvh] font-coaster">:</h1></div>
                        <div className="col-start-3 row-start-3"><h1 className=" text-[3dvh] font-coaster">:</h1></div>
                        <div className="col-start-3 row-start-4"><h1 className=" text-[3dvh] font-coaster">:</h1></div>
                        <div className="col-span-4 col-start-4 row-start-1"><h1 className=" text-[3dvh] font-coaster">Upto ₹ 5K</h1></div>
                        <div className="col-span-4 col-start-4 row-start-2"><h1 className=" text-[3dvh] font-coaster">Free</h1></div>
                        <div className="col-span-4 col-start-4 row-start-3"><h1 className=" text-[3dvh] font-coaster">Shashwat</h1></div>
                        <div className="col-span-4 col-start-4 row-start-4"><h1 className=" text-[3dvh] font-coaster">9708912332</h1></div>
                    </div>
